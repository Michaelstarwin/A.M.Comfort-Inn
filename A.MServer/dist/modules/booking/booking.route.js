...
router.post('/check-availability', (0, validate_middleware_1.validate)(booking_validation_1.checkAvailabilitySchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield BookingService.checkAvailability(req.body);
...
router.post('/pre-book', (0, validate_middleware_1.validate)(booking_validation_1.preBookSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield BookingService.preBook(req.body);
...
router.post('/payment/create-order', (0, validate_middleware_1.validate)(booking_validation_1.createOrderSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // First validate the booking
        const bookingData = yield BookingService.createOrder(req.body);
        // Create Razorpay order
        const result = yield razorpayService.createOrder({
...
router.post('/payment/razorpay-webhook', express_1.default.raw({ type: 'application/json' }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get('/:referenceNumber', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const booking = yield BookingService.getBookingByReference(req.params.referenceNumber);
    if (!booking) {
...
router.get('/admin/inventory/room-types', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const rooms = yield BookingService.getRoomInventory();
...
router.post('/admin/inventory/room-types', auth_middleware_1.isAdmin, roomImageUpload_1.uploadRoomImage, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newRoom = yield BookingService.createRoomType(data);
...
router.put('/admin/inventory/room-types/:roomId', auth_middleware_1.isAdmin, roomImageUpload_1.uploadRoomImage, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedRoom = yield BookingService.updateRoomType(req.params.roomId, data);
...
router.delete('/admin/inventory/room-types/:roomId', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield BookingService.deleteRoomType(req.params.roomId);
    res.status(200).json({ success: true, message: 'Room type deactivated successfully.', data: result });
}));
// Admin: Get all bookings with filters
router.get('/admin/bookings', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { status, search, page = 1, limit = 20 } = req.query;
        const bookings = yield BookingService.getAdminBookings({
            status: status,
            search: search,
            page: parseInt(page),
...
router.get('/admin/bookings/:bookingId', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const booking = yield BookingService.getBookingDetailsAdmin(req.params.bookingId);
        res.status(200).json({ success: true, data: booking });
    }
    catch (error) {
        res.status(400).json({ success: false, message: error.message });
...
router.put('/admin/bookings/:bookingId/status', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { status } = req.body;
        const booking = yield BookingService.updateBookingStatus(req.params.bookingId, status);
...
// Admin: Get analytics
router.get('/admin/analytics', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { period = 'month' } = req.query;
        const analytics = yield BookingService.getAnalytics(period);
...
router.get('/admin/analytics/revenue', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { period = 'month' } = req.query;
        const revenue = yield BookingService.getRevenueAnalytics(period);
...
router.get('/admin/analytics/occupancy', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const occupancy = yield BookingService.getOccupancyStats();
...
router.get('/admin/analytics/top-rooms', auth_middleware_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const topRooms = yield BookingService.getTopRoomTypes();
