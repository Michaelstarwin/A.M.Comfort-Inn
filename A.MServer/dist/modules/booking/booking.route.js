...
router.post('/payment/create-order', async (req, res) => {
    try {
        ...
        if (hasBookingData) {
            ...
            const { createOrderWithBookingDataSchema } = await Promise.resolve().then(() => __importStar(require('./booking.validation')));
        ...
        const { createOrderSchema } = await Promise.resolve().then(() => __importStar(require('./booking.validation')));
