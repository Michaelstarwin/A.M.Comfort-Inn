...
export const FacilityCard = ({ icon: Icon, name, delay }) => (
  ...
  >
    <div className="p-4 bg-white rounded-full mb-3 text-orange-500 transition-all duration-300 group-hover:bg-white/20 group-hover:text-white">
      <Icon size={28} />
    </div>
    <p className="text-sm font-semibold text-text-dark group-hover:text-white flex-grow">{name}</p>
  </div>
);