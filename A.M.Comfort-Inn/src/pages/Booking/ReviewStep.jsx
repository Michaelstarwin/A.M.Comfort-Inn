  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <DetailItem label="Check-in" value={`${availabilityData.checkInDate} @ ${availabilityData.checkInTime}`} />
        <DetailItem label="Check-out" value={`${availabilityData.checkOutDate} @ ${availabilityData.checkOutTime}`} />
